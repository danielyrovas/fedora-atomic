...
EXTRA="wezterm rom-properties-gtk3 switcheroo-control system76-scheduler btop wmctrl vulkan-tools steam lutris wine wine-core winetricks protontricks mangohud"

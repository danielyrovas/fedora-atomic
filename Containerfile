...
RUN rpm-ostree override remove bcache-tools fish gcc glow stress-ng \
    tailscale tmux gnome-shell-extension-tailscale-gnome-qs \
    gamemode && ostree container commit
